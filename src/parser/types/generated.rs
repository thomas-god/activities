...
impl FileIdField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            3 => ParseFunction::Simple(parse_uint32z),
...
impl CapabilitiesField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            0 => ParseFunction::Simple(parse_uint8z),
...
impl HrmProfileField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            1 => ParseFunction::Simple(parse_uint16z),
            2 => ParseFunction::Simple(parse_unknown),
            3 => ParseFunction::Simple(parse_uint8z),
            _ => ParseFunction::Simple(parse_uint8),
        }
    }
...
impl SdmProfileField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            5 => ParseFunction::Simple(parse_uint8z),
...
impl BikeProfileField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            3 => ParseFunction::Simple(parse_uint32),
            4 => ParseFunction::Simple(parse_uint16z),
            5 => ParseFunction::Simple(parse_uint16z),
            6 => ParseFunction::Simple(parse_uint16z),
            7 => ParseFunction::Simple(parse_uint16z),
            ...
            21 => ParseFunction::Simple(parse_uint8z),
            22 => ParseFunction::Simple(parse_uint8z),
            23 => ParseFunction::Simple(parse_uint8z),
            24 => ParseFunction::Simple(parse_uint8z),
            37 => ParseFunction::Simple(parse_uint8),
            38 => ParseFunction::Simple(parse_uint8z),
            39 => ParseFunction::Simple(parse_uint8z),
            40 => ParseFunction::Simple(parse_uint8z),
            41 => ParseFunction::Simple(parse_uint8z),
...
impl EventField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            7 => ParseFunction::Simple(parse_uint16),
            8 => ParseFunction::Simple(parse_uint16),
            9 => ParseFunction::Simple(parse_uint8z),
            10 => ParseFunction::Simple(parse_uint8z),
            11 => ParseFunction::Simple(parse_uint8z),
            12 => ParseFunction::Simple(parse_uint8z),
...
impl DeviceInfoField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            20 => ParseFunction::Simple(parse_uint8z),
            21 => ParseFunction::Simple(parse_uint16z),
...
impl ScheduleField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            2 => ParseFunction::Simple(parse_uint32z),
            3 => ParseFunction::Simple(DateTime::parse),
            4 => ParseFunction::Simple(parse_unknown),
...
impl MemoGlobField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            ...
            3 => ParseFunction::Simple(parse_uint8),
            4 => ParseFunction::Simple(parse_uint8z),
            _ => ParseFunction::Simple(parse_uint8),
        }
    }
...
impl AntChannelIdField {
    ...
    fn get_parse_function(def_number: u8) -> ParseFunction {
        match def_number {
            0 => ParseFunction::Simple(parse_uint8),
            1 => ParseFunction::Simple(parse_uint8z),
            2 => ParseFunction::Simple(parse_uint16z),
            3 => ParseFunction::Simple(parse_uint8z),
